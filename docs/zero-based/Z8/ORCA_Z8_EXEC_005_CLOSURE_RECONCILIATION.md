...
- Closure branch: `work/orca-exec-005-closure-reconciliation-20260726`
...
4. Closure diff contains documentation/governance files only after removal of any temporary reconciliation mechanism.
