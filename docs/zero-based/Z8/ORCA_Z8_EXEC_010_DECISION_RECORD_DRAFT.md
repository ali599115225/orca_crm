# ORCA Z8 — EXEC-010 Owner Decision Record (Draft)

- Package: `EXEC-010 — Documents, privacy, reporting and export controls`
- Status: `OWNER APPROVAL REQUIRED / NO IMPLEMENTATION AUTHORITY`
- Date: `2026-08-11`

The execution-package registry requires `OWN-C01`, approved privacy notices/rights/purpose policy, approved KPI definitions, and keeps storage/scanner selection separate. This record proposes the narrowest safe Release-1 decisions and does not treat them as approved until the owner explicitly accepts them.
...
`APPROVED — EXEC-010 D10-01 THROUGH D10-08`

Until that exact owner approval exists, Scope Freeze and Runtime implementation remain unauthorized.
