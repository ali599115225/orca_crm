            ...
            <div className="bg-[var(--nc-surface-solid)] border border-white/5 rounded-2xl p-4 shadow-xl space-y-3">
              <div className="flex justify-between items-center border-b border-white/5 pb-2">
                <h4 className="text-lg font-semibold text-white flex items-center gap-2">
                  ...
                  <span>سجل تتبع أحداث العروض العقارية الفورية (Offer Event Telemetry Console)</span>
                </h4>
                <button
                  onClick={() => setTelemetryLogs([])}
                  className="text-xs text-slate-500 text-rose-400 hover:text-rose-300 font-semibold"
                >
                  مسح السجل
                </button>
              </div>
