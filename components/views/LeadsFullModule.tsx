...
export default function LeadsFullModule() {
  ...
  return (
    <div className="flex h-[85vh] w-full gap-4 p-4">
        ...
        <div key={stage} className="flex-1 bg-[#032238]/30 border border-white/5 rounded-xl flex flex-col overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto p-2 space-y-2">
            {initialLeads.filter(l => l.stage === stage).map(lead => (
              ...
              >
                <h4 className="text-white text-sm">{lead.name}</h4>
      ...
      {/* اللوحة الجانبية المتكاملة التي تظهر عند النقر */}
      {selectedLead && (
        <div className="w-[450px] bg-[#001F33] border-l border-white/10 p-6 overflow-y-auto shadow-2xl animate-in slide-in-from-right">
