...
export const EXEC_003_PERMISSION_ASSIGNMENTS = [
  ...
  {
    contractId: "EXEC-003-C26",
    priority: "P0_SECURITY_CRITICAL_SURFACE",
    kind: "API",
    routeOrContract: "/api/v1/contracts/[id]/signatories",
    source: "app/api/v1/contracts/[id]/signatories/route.ts",
    operations: [
      databaseOperation(
        "PUT",
        "contracts.signatories.configure",
  ...
  {
    contractId: "EXEC-003-C28",
    priority: "P0_SECURITY_CRITICAL_SURFACE",
    kind: "API",
    routeOrContract: "/api/v1/contracts/[id]/amendments/[amendmentId]/approve",
    source: "app/api/v1/contracts/[id]/amendments/[amendmentId]/approve/route.ts",
    operations: [
      databaseOperation(
        "POST",
        "contracts.amendment.approve",
  ...
  {
    contractId: "EXEC-003-C30",
    priority: "P0_SECURITY_CRITICAL_SURFACE",
    kind: "API",
    routeOrContract: "/api/v1/contracts/[id]/amendments/[amendmentId]/apply",
    source: "app/api/v1/contracts/[id]/amendments/[amendmentId]/apply/route.ts",
    operations: [
      databaseOperation(
        "POST",
        "contracts.amendment.apply",
