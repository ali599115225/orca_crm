...
export const PERMISSION_REGISTRY = [
  ...
  p('unit-commitments.availability-read', 'unit-commitments', 'availability-read', 'READ', TENANT_SCOPES, ['lib/unit-commitment/authority.ts'], 'Read effective unit availability and blocking commitment state.'),
  p('unit-commitments.hold-create', 'unit-commitments', 'hold-create', 'WRITE', TENANT_SCOPES, ['lib/unit-commitment/authority.ts'], 'Create a temporary unit hold.'),
  p('unit-commitments.hold-extend', 'unit-commitments', 'hold-extend', 'WRITE', TENANT_SCOPES, ['lib/unit-commitment/authority.ts'], 'Extend an active unit hold.'),
  p('unit-commitments.hold-release', 'unit-commitments', 'hold-release', 'WRITE', TENANT_SCOPES, ['lib/unit-commitment/authority.ts'], 'Release or expire an active unit hold.'),
  p('unit-commitments.hold-override', 'unit-commitments', 'hold-override', 'APPROVE', TENANT_SCOPES, ['lib/unit-commitment/authority.ts'], 'Approve an elevated unit hold override.'),
  p('unit-commitments.reservation-create', 'unit-commitments', 'reservation-create', 'WRITE', TENANT_SCOPES, ['lib/unit-commitment/authority.ts'], 'Create a unit reservation.'),
  p('unit-commitments.reservation-approve', 'unit-commitments', 'reservation-approve', 'APPROVE', TENANT_SCOPES, ['lib/unit-commitment/authority.ts'], 'Approve or reject a pending unit reservation.'),
  p('unit-commitments.reservation-extend', 'unit-commitments', 'reservation-extend', 'APPROVE', TENANT_SCOPES, ['lib/unit-commitment/authority.ts'], 'Extend an active unit reservation.'),
  p('unit-commitments.reservation-release', 'unit-commitments', 'reservation-release', 'APPROVE', TENANT_SCOPES, ['lib/unit-commitment/authority.ts'], 'Release an active or pending unit reservation.'),
  p('unit-commitments.reservation-cancel', 'unit-commitments', 'reservation-cancel', 'APPROVE', TENANT_SCOPES, ['lib/unit-commitment/authority.ts'], 'Cancel a unit reservation.'),
  p('unit-commitments.reservation-convert', 'unit-commitments', 'reservation-convert', 'APPROVE', TENANT_SCOPES, ['lib/unit-commitment/authority.ts'], 'Convert a reservation into its downstream commitment state.'),
  p('unit-commitments.audit-read', 'unit-commitments', 'audit-read', 'READ', TENANT_SCOPES, ['lib/unit-commitment/authority.ts'], 'Read unit commitment lifecycle evidence.'),
