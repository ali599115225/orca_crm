...
import { linkRentalHandover } from "@/lib/domain/rental/rental-closure-service";
  ...
  return runWithDatabaseSession(
    ...
    async (session) => {
      try {
        ...
        const data = await linkRentalHandover({
          tenantId: session.tenantId,
          leaseId: id,
          handoverId: requiredRentalString(body, "handoverId"),
