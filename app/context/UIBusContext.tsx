...
const NOTIFICATION_ICON_COLORS: Record<NotificationType, string> = {
  ...
  error: "text-[var(--nc-text-secondary)]",
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        {notification.message && (
          <p className="text-[var(--nc-text-dim)] font-medium text-xs mt-0.5 leading-relaxed">{notification.message}</p>
        )}
        {notification.action && (
          <button
      ...
      <button
        ...
        className="text-[var(--nc-text-dim)] font-medium hover:text-white text-lg leading-none transition-colors flex-shrink-0"
