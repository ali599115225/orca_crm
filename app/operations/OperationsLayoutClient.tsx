...
const TRANSLATIONS = {
  AR: {
    ...
    studioOperations: "مكتب استوديو العمليات",
    logout: "تسجيل الخروج",
  ...
  EN: {
    ...
    studioOperations: "Studio Operations Desk",
    logout: "Logout",
    ...
    >
      ...
      >
        ...
        <nav className="flex-1 p-4 space-y-1.5 text-xs font-bold overflow-y-auto">
          ...
          {(userRoleKey?.toLowerCase() === 'agent' || userRoleKey === 'SALES_EMPLOYEE') && (
            <a 
            ...
            >
              ...
              <span>{lang === 'AR' ? 'مساحة عمل المستشار' : 'Consultant Workspace'}</span>
            </a>
          )}
