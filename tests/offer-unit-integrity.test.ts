...
describe("Offer Unit Integrity", () => {
  ...
  // SOURCE test "keeps the list page standalone and the offer/tour flows on
  // the official detail route" intentionally removed here: it asserted against
  // app/operations/leads/page.tsx and features/leads/components/* which are
  // legacy visual/page architecture not yet rebuilt in TARGET's clean-room
  // (PAGE work not started). No non-visual invariant from that test survives
  // independently of those page files.
});
