...
const HISTORICAL_MIGRATION = readFileSync(join(ROOT, "prisma", "migration-evidence", "non-production", "20260721020000_g3_rbac_constraints_indexes", "migration.sql"), "utf8");
